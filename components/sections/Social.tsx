...
const socialLinks = [
  {
    ...
    label: "GitHub",
    hoverClass: "hover:bg-purple-500 hover:border-purple-500 hover:shadow-purple-500/30",
  },
  {
    icon: Linkedin,
    href: "https://www.linkedin.com/in/hamzabraik/",
    label: "LinkedIn",
    hoverClass: "hover:bg-blue-500 hover:border-blue-500 hover:shadow-blue-500/30",
  },
  {
    icon: Mail,
    href: "mailto:braikhamza8@gmail.com",
    label: "Email",
    hoverClass: "hover:bg-teal-500 hover:border-teal-500 hover:shadow-teal-500/30",
  },
];
